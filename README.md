...
# Workflow:
Built with React-native(https://reactnative.dev/) and the official Algorand SDK(https://developer.algorand.org/docs/sdks/javascript/), the app makes exploring it convenient for users to create, buy, and trade event tickets securely and transparently, eliminating common issues such as fraud, scalping, and excessive fees. 
